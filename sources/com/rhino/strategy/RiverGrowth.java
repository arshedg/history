 ...
 * @author arshed
 */
public class RiverGrowth implements Strategy{

    private static final float TARGET=  .8f;
    private static  List<Equity> getAll() throws SQLException{
        String from = "2014-06-30";
        String to="2016-01-1";
...
@Test
    public  void runStrategy() throws SQLException {
        Strategy strategy = new RiverGrowth();
